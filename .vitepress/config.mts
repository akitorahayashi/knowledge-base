      ...
      '/apple-ecosystem/': [
        {
          ...
          items: [
            { text: 'Apple Ecosystem トップ', link: '/apple-ecosystem/index' },
      ...
      '/flutter/': [
        {
          text: 'Flutter開発',
          items: [
            { text: 'Flutter トップ', link: '/flutter/index' },
      ...
      '/python/': [
        {
          text: 'Python開発',
          items: [
            { text: 'Python トップ', link: '/python/index' },
      ...
      '/gemini-gem-prompt/': [
        {
          ...
          items: [
            { text: 'トップ', link: '/gemini-gem-prompt/index' },
